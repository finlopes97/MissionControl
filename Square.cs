...
public class Square
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Square"/> class with the specified obstacle and coordinates.
    /// </summary>
    ...
    public Square(OrderedPair coord, IObstacle? obstacle = null)
    {
        ThisCoord = coord;
