...
Add some custom obstacles here for full marks!

# Implementation
Obstacles should inherit from a base class that holds the majority of their information:

## Obstacle Class
An abstract class that holds the shared members of each inheriting class, such as position and alphabetical code. 
